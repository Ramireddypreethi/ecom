import sys
import os
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))) # it adds parent directory of current path to search path, even though they are located in different directory python can import modules in other directory
